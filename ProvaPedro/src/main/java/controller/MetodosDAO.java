...
public class MetodosDAO {
    ...
    public void cadastroFuncionario(Funcionario fun)throws ClassNotFoundException, SQLException{
        Connection con = Conexao.getConexao();
        PreparedStatement comando = con.prepareStatement("insert into funcionario(nomeFun,sobrenomeFun,dataNascimentoFun,rgFun,cpfFun) values (?,?,?,?,?)");
        comando.setString(1, fun.getNomeFun());
        comando.setString(2, fun.getSobrenomeFun());
        comando.setString(3, fun.getDataNascimentoFun());
        comando.setString(4, fun.getRgFun());
        comando.setString(5, fun.getCpfFun());
        comando.execute();
        con.close();
    }
    ...
    public void cadastrarCliente(Cliente cli)throws ClassNotFoundException, SQLException{
        Connection con = Conexao.getConexao();
        PreparedStatement comando = con.prepareStatement("insert into cliente (nomeCli,sobrenomeCli,dataNascimentoCli,rgCli,cpfCli,gasto) values (?,?,?,?,?,?)");
        comando.setString(1, cli.getNomeCli());
        comando.setString(2, cli.getSobrenomeCli());
        comando.setString(3,cli.getDataNascimentoCli());
        comando.setString(4, cli.getRgCli());
        comando.setString(5,cli.getCpfCli());
        comando.setFloat(6,cli.getGasto());
        comando.execute();
        con.close();
    }
    ...
    public void alterarFuncionario (Funcionario fun)throws ClassNotFoundException, SQLException{
        Connection con = Conexao.getConexao();
        PreparedStatement comando = con.prepareStatement("update funcionario set nomeFun = ?, sobrenomeFun = ?, dataNascimentoFun = ?, rgFun = ?, cpfFun = ? where idFun = ?");
        comando.setString(1, fun.getNomeFun());
        comando.setString(2, fun.getSobrenomeFun());
        comando.setString(3, fun.getDataNascimentoFun());
        comando.setString(4, fun.getRgFun());
        comando.setString(5, fun.getCpfFun());
        comando.setInt(6, fun.getIdFun());
        comando.execute();
        con.close();
    }
    ...
    public void alterarCliente (Cliente cli)throws ClassNotFoundException, SQLException{
        Connection con = Conexao.getConexao();
        PreparedStatement comando = con.prepareStatement("update cliente set nomeCli = ?, sobrenomeCli = ?, dataNascimentoCli= ?, rgCli = ?, cpfCli = ?, gasto = ? where idCli = ?");
        comando.setString(1, cli.getNomeCli());
        comando.setString(2, cli.getSobrenomeCli());
        comando.setString(3,cli.getDataNascimentoCli());
        comando.setString(4, cli.getRgCli());
